...
risking, so the size shrinks. Past <b>%(maxd).0f points</b> the setup is skipped.</p>
<div class="scroll"><table id="o_grid">
<caption>Fill depth is how far back inside the level the price you got was. Size assumes gold at
$1 per point per lot; check it against your own contract.</caption>
<thead><tr><th>Fill depth</th><th>You filled at</th><th>Risk</th><th>Target</th><th>Size</th></tr></thead>
...
(function(){
  ...
  var hi=document.getElementById('cy_hi'), lo=document.getElementById('cy_lo'),
      bal=document.getElementById('c_bal'), rk=document.getElementById('c_risk'),
  ...
  [hi,lo,bal,rk].forEach(function(el){el.oninput=calc});
  calc();
})();
